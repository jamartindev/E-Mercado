      ...
      function checkMedia (mediaQ) {
        if (mediaQ.matches) {
          ...
          <div class="card__content">
            <p class="card__title nameDivR">${name} - ${currency} ${cost}</p>
            <p class="card__description descDivR"> ${description} </p>
                  ...
                  <div class="my-2 py-2">
                        ...
                        <div class="d-flex shadow justify-content-between ">
                          <div class="d-flex">
                            ...
                            <div class="ms-3">
                              <p class="h2 fw-normal nameDiv">${name} - ${currency} ${cost}</p> 
                              <p class= "descDiv">${description}</p>
                            </div>   
                          </div>   
  ...
  function searchFilter() {
    ...
    searchbar.addEventListener("input", () => {
      for (let i = 0; i < products.length; i++) {
        ...
        if (xMedia.matches) {
          nameDiv = document.querySelectorAll(".nameDivR");
          descDiv = document.querySelectorAll(".descDivR");
          
        } else {
          nameDiv = document.querySelectorAll(".nameDiv");
          descDiv = document.querySelectorAll(".descDiv");
